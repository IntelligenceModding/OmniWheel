...
public final class GeometryRenderer {
    ...
    public static void fillRingSegment(
        ...
        graphics.guiRenderState.submitGuiElement(new PolygonRenderState(mesh, pose, centerX, centerY, color, scissor, bounds));
    }
    ...
    private static ScreenRectangle boundsFor(float centerX, float centerY, float outerRadius, Matrix3x2f pose, ScreenRectangle scissor) {
