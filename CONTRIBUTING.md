...
For example, a change developed for Minecraft 26.1.1 with Fabric should target the corresponding 26.1.1 Fabric branch.
...
For example, the Minecraft 26.1.1 Fabric branch uses Java 25.
