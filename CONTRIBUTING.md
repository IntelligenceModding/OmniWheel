...
For example, a change developed for Minecraft 26.2 with Fabric should target the corresponding 26.2 Fabric branch.
...
For example, the Minecraft 26.2 Fabric branch uses Java 25.
