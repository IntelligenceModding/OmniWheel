...
For example, a change developed for Minecraft 1.21.4 with Fabric should target the corresponding 1.21.4 Fabric branch.
...
For example, the Minecraft 1.21.4 Fabric branch uses Java 21.
